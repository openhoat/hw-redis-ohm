...
Entity.prototype.delete = function (multi) {
  ...
  log.trace('Entering Entity.prototype.delete');
  localMulti = !multi;
...
Entity.prototype.removeIndexes = function (multi) {
  ...
  log.trace('Entering Entity.prototype.removeIndexes');
  localMulti = !multi;
  multi = multi || ohm.multi();
  return p.do(function () {
    clazz = entity.getClass();
...
Entity.prototype.removeLinks = function (multi) {
  var entity = this
    , localMulti, type, id;
  log.trace('Entering Entity.prototype.removeLinks');
  localMulti = !multi;
  multi = multi || ohm.multi();
  return p.do(function () {
    type = entity.type;
...
Entity.prototype.save = function (multi) {
  ...
  log.trace('Entering Entity.prototype.save');
  localMulti = !multi;
  multi = multi || ohm.multi();
  return p.do(
    function check() {
...
Entity.prototype.saveIndexes = function (multi) {
  var entity = this
    , localMulti, clazz, type, id;
  log.trace('Entering Entity.prototype.saveIndexes');
  localMulti = !multi;
  multi = multi || ohm.multi();
  return p.do(function () {
    clazz = entity.getClass();
...
Entity.prototype.saveLinks = function (multi) {
  var entity = this
    , localMulti, type, id;
  log.trace('Entering Entity.prototype.saveLinks');
  localMulti = !multi;
  multi = multi || ohm.multi();
  return p.do(function () {
    type = entity.type;
...
Entity.prototype.update = function (multi) {
  ...
  log.trace('Entering Entity.prototype.update');
  localMulti = !multi;
  multi = multi || ohm.multi();
  return p.do(
    function check() {
